...
const t = {
  en: {
    ...
    name: 'Name', sortOrder: 'Sort Order', active: 'Active',
    actions: 'Actions',
    ...
    retry: 'Retry', nameRequired: 'Name is required.'
  },
  ar: {
    title: 'شركات التمويل', add: 'إضافة شركة', search: 'بحث في الشركات...',
    name: 'الاسم', sortOrder: 'الترتيب', active: 'نشطة',
    actions: 'الإجراءات',
    ...
    retry: 'إعادة المحاولة', nameRequired: 'الاسم مطلوب.'
  },
};

const emptyForm = (): Partial<FinancingCompany> => ({ name: '', isActive: true, sortOrder: 0 });
...
export default function FinancingCompanies({ lang }: Props) {
  ...
  function openEdit(company: FinancingCompany) { setSelected(company); setForm({ name: company.name, isActive: company.isActive, sortOrder: company.sortOrder ?? 0 }); setFormError(null); setModalMode('edit'); }
